...
const footerData = [
    {
        ...
        links: [
            { name: "All Cars", path: "/explore-cars" },
            { name: "Luxury Cars", path: "#", isFake: true },
            { name: "Economy Cars", path: "#", isFake: true },
            { name: "SUVs & Crossovers", path: "#", isFake: true },
            { name: "Electric Vehicles", path: "#", isFake: true },
        ],
    },
    {
        title: "Company",
        links: [
            { name: "About Us", path: "/about" },
            { name: "How It Works", path: "#", isFake: true },
            { name: "Careers", path: "#", isFake: true },
            { name: "Blog", path: "#", isFake: true },
            { name: "Press", path: "#", isFake: true },
        ],
    },
    {
        title: "Support",
        links: [
            { name: "Help Center", path: "#", isFake: true },
            { name: "Contact Us", path: "#", isFake: true },
            { name: "FAQ", path: "#", isFake: true },
            { name: "Rental Terms", path: "#", isFake: true },
            { name: "Insurance", path: "#", isFake: true },
        ],
    },
];
...
const legalLinks = [
    { name: "Privacy Policy", path: "#", isFake: true },
    { name: "Terms of Service", path: "#", isFake: true },
    { name: "Booking Policy", path: "#", isFake: true },
    { name: "Cancellation Policy", path: "#", isFake: true },
];
...
// Component for fake links that show alert
const FakeLink = ({ children, name }) => {
    const handleClick = (e) => {
        e.preventDefault();
    ...
    return (
        <a href="#" onClick={handleClick} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
            {children}
        </a>
    );
};
            ...
            <div className="border-t border-gray-800 bg-black/40">
                <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs sm:text-sm text-gray-400">
                        <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2">
                            {legalLinks.map((link) => (
                                <FakeLink key={link.name} name={link.name}>
                                    {link.name}
                                </FakeLink>
                            ))}
                        </div>
