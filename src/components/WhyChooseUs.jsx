...
const WhyChooseUs = () => {
    ...
    return (
        <section className="py-16 sm:py-20 bg-white text-gray-900">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-black">
                        Why Choose <span className="text-green-600">DriveFleet</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="group bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8 hover:bg-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                        >
                ...
                <div className="mt-16 pt-10 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm mt-1">Car Models</p>
                        </div>
