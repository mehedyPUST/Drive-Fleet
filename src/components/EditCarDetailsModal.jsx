                            ...
                            <Surface variant="default">
                                <form onSubmit={onSubmit} className="p-6 md:p-8 space-y-6">
                                    ...
                                    <div className="flex justify-end gap-3">
                                        <Button slot="close" variant="bordered" size="lg" className="rounded-xl">
                                            Cancel
                                        </Button>
                                        <Button type="submit" size="lg" className="rounded-xl bg-gradient-to-r from-green-500 to-amber-500 text-white font-semibold hover:shadow-lg transition-all">
                                            Update Details
                                        </Button>
                                    </div>
                                </form>
